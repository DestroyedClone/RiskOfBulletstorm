...
namespace RiskOfBulletstormRewrite.Items
{
    public class Mustache : ItemBase<ExampleItem>
    {
        ...
        {
            RegenAmount = config.Bind("Item: " + ItemName, "Regen Amount", 2f, "The amount of regen to gain with one stack.");
            RegenAmountPerStack = config.Bind("Item: " + ItemName, "Regen Amount (Stack)", 1f, "The amount of regen to gain with per stack.");
            Duration = config.Bind("Item: " + ItemName, "Duration", 8f, "The amount of time the buff lasts for.");
            HealOnBloodShrineUse = config.Bind("Item: " + ItemName, "Heal on Health Cost", false, "If true, then the buff will be applied upon purchase of anything that costs health, such as Blood Shrines.");
        }
