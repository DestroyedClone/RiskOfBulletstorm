...
{
    public class BulletstormExtraStatsController
    {
        ...
        {
            private float Scope_SpreadReduction => Items.Scope.SpreadReduction;
            private float Scope_SpreadReductionStack => Items.Scope.SpreadReductionPerStack;
